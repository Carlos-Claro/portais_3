        ...
        <div class="container">
            <div class="conteudo">
                ...
                <div class="body">
                    ...
                    <p>Valor do Imóvel: <b><?php echo number_format($imovel->preco_venda,2,',','.');?></b></p>
                    <p>Valor Entrada: <b><?php echo number_format($dados['valor_entrada'],2,',','.');?></b></p>
                    <p>Quantidade de parcelas da simulação:</p>
                    <ul>
                        <?php 
