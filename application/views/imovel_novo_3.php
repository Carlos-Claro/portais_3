    ...
    <div class="container-fluid corpo imovel" data-imovel="<?php echo $item->_id;?>" data-log="<?php echo $log;?>">
        ...
        <div class="c-product-desc ">
            <div class="container-fluid p-bottom">
                ...
                <span class="primeira-linha"></span>
                <div class="row">
                    <div class="col-lg-8 col-sm-7 col-dm-12 col-xs-12">
                    ...
                    <div class="col-lg-4 col-md-5 col-sm-12 col-xs-12 formulario-original">
                        <div class="formulario">
                            <div class="form-cel" id="form-cel">
...
<div class="hidden-desktop atalho-xs text-center">
    <ul class="list-unstyled list-inline">
        ...
        <li>
            <button type="button" class="btn btn-detalhes btn-azul-pow-reverso " title="Entre em contato" data-toggle="modal" data-target="#modal-formulario-xs"> 
                Contato
            </button>
        </li>
...
<div class="modal fade container" id="modal-formulario-xs" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
