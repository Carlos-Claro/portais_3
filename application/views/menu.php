...
foreach ( $menu as $chave => $valor ): 
    if ( count($valor['itens']) > 0 ):
        ...
        ?><div class="col-md-4"><ul class="dropdown-menu c-menu-type-inline"><li><p><a href="<?php echo str_replace('[tipo]-[oq]','imoveis-'.$chave,$url_); ?>" title="<?php echo $titulo;?>"><?php echo $titulo.' '.$sobre->nome; ?></a></p></li><?php 
